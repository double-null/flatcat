        ...
        <div class="card-block">
            <section>
                <form method="post" enctype="multipart/form-data">
                    {if !empty($success)}<span style="color: #4BCF99;">Отзыв добавлен успешно</span>{/if}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10"><input type="file" name="Photos[0]" class="boxed"></div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 form-control-label text-xs-right"> Фото с клиентом: </label>
                        <div class="col-sm-10"><input type="file" name="Photos[1]" class="boxed"></div>
                    </div>
